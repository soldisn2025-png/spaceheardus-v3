          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[2rem] border border-amber-200 bg-gradient-to-br from-[#fff7dd] via-white to-[#fff1cf] p-6 shadow-[0_24px_80px_rgba(120,53,15,0.06)]">
              ...
              <p className="mt-1 text-sm leading-relaxed text-stone-600">
                Saving writes the updated content to GitHub. The live site reads this content directly, so homepage changes do not need a redeploy and usually appear within about a minute.
              </p>
